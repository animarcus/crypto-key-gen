...
class Curve:
    ...
    def __init__(self):
        ...
        gx = bi("79BE667E F9DCBBAC 55A06295 CE870B07 029BFCDB 2DCE28D9 59F2815B 16F81798".replace(" ", "").encode('utf-8').hex())
        gy = bi("483ADA77 26A3C465 5DA4FBFC 0E1108A8 FD17B448 A6855419 9C47D08F FB10D4B8".replace(" ", "").encode('utf-8').hex())
        self.g = [gx,gy]
        self.n = bi("FFFFFFFF FFFFFFFF FFFFFFFF FFFFFFFE BAAEDCE6 AF48A03B BFD25E8C D0364141".replace(" ", "").encode('utf-8').hex())
